...
const roomTemplate = { name: "Suite A", rate: 18000, discount: 5, bookingList: [] };
...
describe("Room tests", () => {
  ...
  test('Room is occupied', () => {    
    ...
    const isOccupied: boolean = room.isOccupied("19/07/2024");
  ...
  test('Room is not occupied', () => {    
    ...
    const isOccupied: boolean = room.isOccupied("20/07/2024");
  ...
  test('Invalid date for isOccupied method', () => {    
    ...
    const booking1: Booking = new Booking({...bookingTemplate, room, checkIn: "09/07/2024", checkOut: "10/07/2024"});
    const booking2: Booking = new Booking({...bookingTemplate, room, checkIn: "12/07/2024", checkOut: "20/07/2024"});
    room.bookingList = [booking1, booking2];

    const isOccupiedCallback = (): boolean => room.isOccupied("fdsafads")
  ...
  test("Room occupancy percentage", () => {
    ...
    const occupancy: number = room.occupancyPercentage("08/07/2024", "18/07/2024");
  ...
  test("Invalid range for occupancyPercentage method", () => {
    ...
    const occupancyCallback = (): number => room.occupancyPercentage("28/07/2024", "18/07/2024")
  ...
  test("Invalid dates for occupancyPercentage method", () => {
    ...
    const occupancyCallback = (): number => room.occupancyPercentage("gfdgfds", "18/07/2024")

    expect(occupancyCallback).toThrow();
  });

  test("Total occupancy between dates", () => {
    const room1: Room = new Room({...roomTemplate});
    const room1Booking1: Booking = new Booking({...bookingTemplate, room: room1, checkIn: "10/07/2024", checkOut: "13/07/2024"});
    const room1Booking2: Booking = new Booking({...bookingTemplate, room: room1, checkIn: "15/07/2024", checkOut: "16/07/2024"});
    room1.bookingList = [room1Booking1, room1Booking2];

    const room2: Room = new Room({...roomTemplate, name: "Suite B"});
    const room2Booking1: Booking = new Booking({...bookingTemplate, room: room2, checkIn: "09/07/2024", checkOut: "10/07/2024"});
    const room2Booking2: Booking = new Booking({...bookingTemplate, room: room2, checkIn: "12/07/2024", checkOut: "14/07/2024"});
    room2.bookingList = [room2Booking1, room2Booking2];

    const totalOccupancy: number = Room.totalOccupancyPercentage([room1, room2], "08/07/2024", "15/07/2024");
  ...
  test("Invalid dates for availableRooms method", () => {
    ...
    const availableRoomsCallback = (): Room[] => Room.availableRooms([room1, room2], "20/07/2024", "14/gfd/2024")
...
describe("Booking tests", () => {
  ...
  test("Get booking fee", () => {
    const room: Room = new Room({...roomTemplate});
    const booking: Booking = new Booking({...bookingTemplate, room, checkIn: "09/07/2024", checkOut: "10/07/2024"});

    const discountRate: number = booking.getFee();

    expect(discountRate).toBe(15390)
  })

  test("Invalid room discount value", () => {
    const room: Room = new Room({...roomTemplate, discount: -10});
    const booking: Booking = new Booking({...bookingTemplate, room, checkIn: "09/07/2024", checkOut: "10/07/2024"});

    const discountRateCallback = (): number => booking.getFee();
  ...
  test("Invalid booking discount value", () => {
    const room: Room = new Room({...roomTemplate});
    const booking: Booking = new Booking({...bookingTemplate, room, checkIn: "09/07/2024", checkOut: "10/07/2024", discount: -10});
